            ...
            <tr>
                ...
                <td class="erreur">
                    <asp:RequiredFieldValidator ID="RequiredAbregee" ControlToValidate="tbDescAbregee"
                        EnableClientScript="false" ErrorMessage="La description abrégée est obligatoire" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td class="erreur">
                    <asp:RequiredFieldValidator ID="RequiredComplete" ControlToValidate="tbDescComplete"
                        EnableClientScript="false" ErrorMessage="La description complète est obligatoire" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td class="erreur">
                    <asp:RegularExpressionValidator ID="rePrixVente" ControlToValidate="tbPrixVente"
                        EnableClientScript="false" runat="server" ErrorMessage="Le format du prix de vente est invalide" ValidationExpression="^\d{1,6}([\.\,]\d{0,2})?$"> 
