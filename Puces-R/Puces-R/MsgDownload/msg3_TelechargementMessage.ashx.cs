    ...
    public class TelechargementMessage : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                connexion.Open();
                mediaName = "msg" + context.Session["NoDownload"] + "_" + (string)cmdNomFichier.ExecuteScalar();
                connexion.Close();
            ...
            if (fi.Exists)
            {
                ...
                System.Web.HttpContext.Current.Response.AppendHeader("Content-Disposition", "attachment; filename=\"" + mediaName + "\"");
