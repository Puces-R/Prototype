        ...
        <asp:MultiView runat="server" ID="mvMain" ActiveViewIndex="0">
            <asp:View runat="server">
                <div class="panneau pnlGauche">
                    <h2>
                        Articles en panier
                        <asp:Button runat="server" ID="btnViderPanier" Text="Vider le panier" OnClick="btnViderPanier_OnClick"
                            CssClass="boutonApresTitre" /></h2>
                            ...
                            <div class="rectangleProduits rectangleComplet rectangleItem">
                                ...
                                <div class="boiteDetailsProduit">
                                    <div>
                                        ...
                                        <div>
                                            Disponibles :
                                            <asp:Label runat="server" ID="lblQuantiteDispo" />
                                        </div>
                                        <div>
                                            Quantité :
